...
"""  
    ...
    The codes written here were obtained from my solutions to the
    exercises of Andrew Ng's deep learning specialization
"""
import numpy as np
import h5py
import matplotlib.pyplot as plt
from helper_codes import sigmoid, sigmoid_backward, relu, relu_backward
...
def L_model_backward(AL, Y, caches):
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp,\
        dW_temp, \
        db_temp = linear_activation_backward(grads["dA"+str(l+1)], current_cache, activation="relu")
...
parameters = initialize_parameters_deep([5,4,2])
print(L_model_forward(train_set_x_orig, parameters))
